...
import {
  Box, Typography, Button, TextField, MenuItem, Alert, Stack,
  Table, TableHead, TableBody, TableRow, TableCell, TableContainer,
  Paper, Dialog, DialogTitle, DialogContent, DialogActions, Chip, Card, CardContent
} from "@mui/material";
...
function Groups() {
  ...
  async function handleCreate() {
    ...
    try {
      ...
      const data = await res.json();
      if (data.status === "success") { resetForm(); setOpen(false); loadGroups(); }
  ...
  return (
    <Layout active="groups">
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 3, flexWrap: "wrap", gap: 1 }}>
        <Typography variant="h5" fontWeight={800}>Groups</Typography>
